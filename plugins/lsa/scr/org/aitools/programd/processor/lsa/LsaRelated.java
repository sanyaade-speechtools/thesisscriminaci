...
public class LsaRelated extends AIMLProcessor {
	
	public static String label = "lsarelated";
	
	public LsaRelated(Core coreToUse) {
		super(coreToUse);
	}
	...
	public String process(Element element, TemplateParser parser)
		...
		if (element.getChildNodes() != null) {
			...
			if (element.getChildNodes() != null) {
				...
				if(lsaSupport!=null){
					...
					if(related!=null&&related.length>1){
						return splitConstant(related[1]);
					}
					else{
						return "";
					}				
			...
			throw new ProcessorException(
					"<lsarelated></lsarelated> must have content!", null);
		}
